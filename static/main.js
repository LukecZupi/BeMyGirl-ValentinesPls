function changeno(){
    ...
    noButton.dataset.listenerAttached = 'true';
...
// Ensure the no-button handler is attached immediately (so no click is required)
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', changeno);
} else {
    changeno();
}